(function() {
  ...
  var textarea = document.querySelector('.new-post__textarea');
  var hiddenBlock = document.querySelector('.new-post__hidden-block');
  var hint = document.querySelector('.new-post__hint');

  hint.addEventListener('click', function(e) {
    hint.classList.remove('new-post__hint--show');
  })

  textarea.addEventListener('keyup', onKeyDownHandler);
  function onKeyDownHandler(e) {
    var text = textarea.value;
    hiddenBlock.innerText = text;
    var arr = e.target.value.split('')
          
      if(arr.length == 50) {
        hint.classList.add('new-post__hint--show');  
      } 
      if(arr.length < 50) {
        hint.classList.remove('new-post__hint--show');  
      } 
...
//   //input with tags:
//   var tagInput = document.querySelector('.new-post__hidden-tag-input');
  
//   var btn = document.getElementById('add-things')
//   var btnAdd = document.getElementById('add-thing')
//   var input = document.getElementById('new-post__textarea')
//   var container = input.parentNode
//   var thingsList = document.getElementById('things-list')

//   btn.addEventListener('click', (e) => {
//     btn.classList.toggle('new-post__add-tag-btn--active')
//     toggleFieldVisibility();
//   })
//   btnAdd.addEventListener('click', addElementToTemplate)

//   function toggleFieldVisibility () {
//     container.classList.toggle('new-post__form-things-field--show')
//     input.focus()
//   }
...
//       div.classList.add('new-post__tag')
//       div.classList.add('new-post__tag--active')
...
//     if (target.classList.contains('new-post__tag')) {
//       target.classList.toggle('new-post__tag--active')
//     } 
//   }
